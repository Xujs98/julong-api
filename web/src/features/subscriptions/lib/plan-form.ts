...
export function getPlanFormSchema(t: TFunction) {
  return z.object({
    ...
    allow_image_generation_logs: z.boolean(),
    image_generation_log_limit: z.coerce.number().int().min(0),
...
export const PLAN_FORM_DEFAULTS: PlanFormValues = {
  ...
  allow_image_generation_logs: false,
  image_generation_log_limit: 0,
...
export function planToFormValues(plan: SubscriptionPlan): PlanFormValues {
  return {
    ...
    allow_image_generation_logs: plan.allow_image_generation_logs === true,
    image_generation_log_limit: Number(plan.image_generation_log_limit || 0),
...
export function formValuesToPlanPayload(values: PlanFormValues): PlanPayload {
  return {
    plan: {
      ...
      image_generation_log_limit: Number(
        values.image_generation_log_limit || 0
      ),
