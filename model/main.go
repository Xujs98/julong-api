...
` + "`allow_image_generation_logs`" + ` numeric DEFAULT 0,
` + "`image_generation_log_limit`" + ` integer NOT NULL DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "allow_image_generation_logs", DDL: "`allow_image_generation_logs` numeric DEFAULT 0"},
		{Name: "image_generation_log_limit", DDL: "`image_generation_log_limit` integer NOT NULL DEFAULT 0"},
