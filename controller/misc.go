...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"julong_version":              common.Version,
		"upstream_version":            common.UpstreamVersion,
		"upstream_commit":             common.UpstreamCommit,
		...
		"image_generation_log_polling_interval_seconds": common.ImageGenerationLogPollingIntervalSeconds,
		...
		"custom_endpoints":      console_setting.GetCustomEndpoints(),
	...
	if cs.AnnouncementsEnabled {
		data["announcements"] = console_setting.GetActiveAnnouncements(nil)
	}
	if cs.FAQEnabled {
