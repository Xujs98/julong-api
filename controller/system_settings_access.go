...
func optionAllowedForSystemSettingsAction(key, action string) bool {
	...
	allowed := map[string][]string{
		...
		"billing.group-pricing":      {"TopupGroupRatio", "GroupRatio", "UserUsableGroups", "GroupGroupRatio", "AutoGroups", "DefaultUseAutoGroup", "ModelSquareGroupRatioDisplayMode", "TokenGroupRatioDisplayMode", "group_ratio_setting.group_special_usable_group", "group_ratio_setting.model_token_ratio"},
		...
		"billing.invoice":            {"invoice_setting.enabled", "invoice_setting.minimum_amount", "invoice_setting.unit", "invoice_setting.processing_days", "invoice_setting.rejection_freeze_hours"},
		...
		"operations.email-templates": {
			...
			common.DashboardReportEmailEnabledOptionKey,
			common.DashboardReportEmailFrequencyOptionKey,
			common.DashboardReportEmailSendTimeOptionKey,
			common.DashboardReportEmailWeekdayOptionKey,
			common.DashboardReportEmailMonthDayOptionKey,
			common.DashboardReportEmailRecipientUserIDsOptionKey,
			common.DashboardReportEmailSchedulesOptionKey,
			common.RiskUserEmailEnabledOptionKey,
			common.RiskUserEmailLevelsOptionKey,
			common.RiskUserEmailRecipientUserIDsOptionKey,
			common.UserPresenceEmailEnabledOptionKey,
			common.UserPresenceEmailEventsOptionKey,
			common.UserPresenceEmailMonitoredUserIDsOptionKey,
			common.UserPresenceEmailRecipientUserIDsOptionKey,
			common.UserPresenceOfflineMinutesOptionKey,
		},
