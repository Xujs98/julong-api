...
func optionAllowedForSystemSettingsAction(key, action string) bool {
	...
	allowed := map[string][]string{
		...
		"billing.group-pricing":      {"TopupGroupRatio", "GroupRatio", "UserUsableGroups", "GroupGroupRatio", "AutoGroups", "DefaultUseAutoGroup", "ModelSquareGroupRatioDisplayMode", "TokenGroupRatioDisplayMode", "group_ratio_setting.group_special_usable_group"},
