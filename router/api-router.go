...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/error-reports", middleware.TryUserAuth(), anonymousRequestBodyLimit, controller.SubmitErrorReport)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/agent/users", controller.GetAgentUsers)
				selfRoute.PUT("/agent/topup-link", controller.UpdateAgentTopUpLink)
				selfRoute.GET("/topup/info", controller.GetTopUpInfo)
				selfRoute.GET("/topup/self", controller.GetUserTopUps)
				selfRoute.GET("/invoice", controller.GetInvoiceInfo)
				selfRoute.POST("/invoice/apply", middleware.CriticalRateLimit(), controller.ApplyInvoice)
				selfRoute.POST("/invoice/applications/:id/cancel", middleware.CriticalRateLimit(), controller.CancelInvoiceApplication)
				selfRoute.GET("/invoice/applications/:id/attachment", middleware.DisableCache(), controller.DownloadInvoiceAttachment)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/invoice/applications", controller.AdminGetInvoiceApplications)
				adminRoute.GET("/invoice/email-templates", controller.AdminGetInvoiceEmailTemplates)
				adminRoute.PUT("/invoice/applications/:id", controller.AdminUpdateInvoiceApplication)
				adminRoute.POST("/invoice/applications/:id/complete", controller.AdminCompleteInvoiceApplication)
				adminRoute.POST("/invoice/applications/:id/withdraw", controller.AdminWithdrawCompletedInvoiceApplication)
				adminRoute.POST("/topup/complete", controller.AdminCompleteTopUp)
				adminRoute.GET("/search", controller.SearchUsers)
				adminRoute.GET("/quota-summary", controller.GetUserQuotaSummary)
				adminRoute.GET("/quota-summary/settings", controller.GetUserQuotaSummarySettings)
				adminRoute.PUT("/quota-summary/settings", controller.UpdateUserQuotaSummarySettings)
				adminRoute.GET("/quota-summary/users", controller.SearchUserQuotaSummaryOptions)
				adminRoute.POST("/quota-summary/users/resolve", controller.ResolveUserQuotaSummaryOptions)
				...
				adminRoute.DELETE("/tags/:tag_id", controller.DeleteUserTag)
				adminRoute.GET("/options", controller.SearchUserManagementOptions)
				adminRoute.POST("/options/resolve", controller.ResolveUserManagementOptions)
				...
				adminRoute.DELETE("/:id/request-content", controller.AdminDeleteUserRequestContentLogs)
				adminRoute.GET("/:id/oauth/bindings", controller.GetUserOAuthBindingsByAdmin)
				adminRoute.DELETE("/:id/oauth/bindings/:provider_id", controller.UnbindCustomOAuthByAdmin)
				adminRoute.DELETE("/:id/bindings/:binding_type", controller.AdminClearUserBinding)
				adminRoute.PUT("/:id/tag", controller.UpdateUserTagAssignment)
		...
		errorReportsRoute := apiRouter.Group("/error-reports")
		errorReportsRoute.Use(middleware.AdminAuth())
		{
		...
		emailSettingsRoute.Use(middleware.AdminAuth(), middleware.RequirePermission(authz.SystemSettingsPermission("operations.email-templates")))
		{
			...
			emailSettingsRoute.GET("/monitored-users", controller.SearchUserPresenceMonitoredUsers)
			emailSettingsRoute.POST("/monitored-users/resolve", controller.ResolveUserPresenceMonitoredUsers)
			...
			emailSettingsRoute.POST("/risk-user/test", controller.SendRiskUserTestEmail)
			emailSettingsRoute.POST("/user-presence/test", controller.SendUserPresenceTestEmail)
		}
		...
		registerLedgerRoutes(apiRouter)
		...
		redemptionRoute.Use(middleware.UserAuth())
		{
		...
		dataRoute.GET("/groups", middleware.RootAuth(), controller.GetQuotaDatesByGroup)
